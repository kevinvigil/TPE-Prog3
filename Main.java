...
import TPE.servicios.ServicioBFS;
import TPE.servicios.ServicioCaminos;
import TPE.servicios.ServicioDFS;
...
public class Main {
	...
	public static void cargaConsola(Grafo g){
		try {
			...
			while (value != "TPE\\dataTest\\DT1.txt" && value != "TPE\\dataTest\\DT2.txt" && value != "TPE\\dataTest\\DT3.txt") {
